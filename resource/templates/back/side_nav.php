            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="index.php?orders"><i class="fa fa-fw fa-table"></i> View Orders</a>
                    </li>
                     <li>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="index.php?reports"><i class="fa fa-fw fa-wrench">
                            
                            </i>reports</a>
                    </li>
                    
                   <li>
                        <a href="index.php?slides"><i class="fa fa-fw fa-wrench">
                            </i>slides</a>
                    </li> 
